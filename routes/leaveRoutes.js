...
const validateReviewLeave = [
  ...
  body('replacementStaff').optional().isArray().withMessage('Replacement staff must be an array'),
...
const validateLeaveById = [param('id').isMongoId().withMessage('Valid leave ID is required')];
